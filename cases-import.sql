;
delete from public.projects where slug = 'dream-house';
...
values (
  'p-pulse',
  'ПУЛЬС — Движение как опора',
  'pulse',
  'landing',
  2026,
  'ПУЛЬС · концепт',
  'https://papagama.github.io/pulse/',
  'Концепт лендинга тренировочного зала в Калининграде, который предлагает найти свой устойчивый ритм движения.',
  $case$
    <h3>Контекст</h3>
    <p>ПУЛЬС — концепт лендинга тренировочного зала в Калининграде. Вместо обещаний «идеальной формы» он предлагает движение как спокойную, регулярную часть дня.</p>
    <h3>Задача</h3>
    <p>Снять порог входа и построить маршрут, который сначала показывает характер пространства, затем помогает выбрать направление, а после приглашает сделать первый шаг.</p>
    <h3>Структура и UX</h3>
    <p>Путь идёт от манифеста «Движение — твоя опора» к блоку выбора состояния, тренировочным сценам и финальной точке входа. В прототипе честно указано, что данные формы никуда не отправляются.</p>
    <h3>Визуальная система</h3>
    <p>Крупная контрастная типографика держит ритм первого экрана. Светлый фон, тёмный текст и яркие акценты работают вместе с фотографиями функциональной и групповой тренировки.</p>
    <h3>Функциональность</h3>
    <p>Сценарий демонстрирует навигацию по разделам и способ записи, который можно подключить после выбора реального процесса работы зала.</p>
    <h3>Результат</h3>
    <p>Создан адаптивный прототип тренировочного зала, в котором визуальный характер, поддерживающий язык и путь к первому действию образуют единый маршрут.</p>
  $case$,
  'https://papagama.github.io/pulse/assets/group-training.png',
  '["https://papagama.github.io/pulse/assets/hero-training.png","https://papagama.github.io/pulse/assets/kettlebell-training.png"]'::jsonb,
  '["https://papagama.github.io/pulse/assets/group-training.png","https://papagama.github.io/pulse/assets/hero-training.png","https://papagama.github.io/pulse/assets/kettlebell-training.png"]'::jsonb,
  '[]'::jsonb,
